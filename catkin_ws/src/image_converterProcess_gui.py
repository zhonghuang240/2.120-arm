...
#   def __init__(self):
    ...
    # self.depth_sub = rospy.Subscriber("/camera/infra1/image_rect_raw",Image,self.callback)
    # self.image_pub = rospy.Publisher("image_topic_2",Image)
    ...
    # self.bridge = CvBridge()
    # # self.image_sub = rospy.Subscriber("image_topic",Image,self.callback)
    # # self.image_pub = rospy.Publisher("image_topic_2",Image)p
...
global tk
tk = Tk()
global canny, center, dist, d_p, bridge

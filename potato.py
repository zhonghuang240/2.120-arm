...
from move_group_python_interface_tutorial_wo_gripper_wo_custom_topic import all_close, MoveGroupPythonIntefaceTutorial
...
class Arm(object):
    ...
    def __init__(self, COM_port, stack_number, UR5_object):
        ...
        self.HOME_POSITION = [0.75, 0.0, 0.35, 0.0, 0.7071, 0.0, 0.7071]
